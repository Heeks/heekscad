...
private:
    static unsigned int required_decimal_places;   // How many digits AFTER the decimal point do we require?

public:
    static void SetRequiredDecimalPlaces( const unsigned int _required )
    {
        required_decimal_places = _required;
    }

    const unsigned int Precision( const double value ) const;
    TIXML_STRING Format( const double value ) const;
