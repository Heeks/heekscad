...
public:
    ...
    */
    ...
    {
        return m_pPropGrid->GetPropertyColor(id);
    }
    inline wxColour GetPropertyColor( wxPGPropNameStr name ) const
    {
        return m_pPropGrid->GetPropertyColor(name);
    }
...
*/
    ...
    */
    ...
    inline void SetPropertyColorToDefault( wxPGId id )
    {
        m_pPropGrid->SetPropertyColorToDefault(id);
    }
    inline void SetPropertyColorToDefault ( wxPGPropNameStr name )
    {
        m_pPropGrid->SetPropertyColorToDefault(name);
    }
