...
static unsigned char rotation_circle[26] = {0x03, 0xe0, 0x0c, 0x18, 0x10, 0x04, 0x60, 0x02, 0x61, 0xc2, 0x06, 0x31, 0x04, 0x10, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x04, 0x10, 0x06, 0x30, 0x01, 0xc0};
static unsigned char rotation_object_circle[26] = {0x03, 0xe0, 0x0c, 0x18, 0x10, 0x04, 0x60, 0x02, 0x61, 0xc2, 0x07, 0xf1, 0x07, 0xf0, 0x0f, 0xf8, 0x0f, 0xf8, 0x0f, 0xf8, 0x07, 0xf0, 0x07, 0xf0, 0x01, 0xc0};
...
static unsigned char stretch_circle[24] = {0x30, 0x03, 0x50, 0x05, 0x30, 0x03, 0x09, 0xc8, 0x06, 0x30, 0x04, 0x10, 0x09, 0x48, 0x08, 0x08, 0x0a, 0x28, 0x05, 0xd0, 0x06, 0x30, 0x01, 0xc0};
...
void Gripper::glCommands(bool select, bool marked, bool no_color){
	...
	switch(m_gripper_type){
		...
		case GripperTypeRotateObject:
			glBitmap(16, 13, 8, 8, 10.0, 0.0, rotation_object_circle);
			break;
		case GripperTypeRotate:
			glBitmap(16, 13, 8, 8, 10.0, 0.0, rotation_circle);
			break;
		case GripperTypeScale:
			glBitmap(16, 15, 8, 8, 10.0, 0.0, scale_circle);
			break;
		case GripperTypeAngle:
			glBitmap(14, 16, 9, 11, 10.0, 0.0, angle_circle);
			break;
		case GripperTypeStretch:
			glBitmap(16, 12, 8, 7, 10.0, 0.0, stretch_circle);
			break;
		default:
